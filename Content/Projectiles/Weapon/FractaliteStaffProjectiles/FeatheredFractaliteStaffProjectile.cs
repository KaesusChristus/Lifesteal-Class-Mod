...
{
    public class FeatheredFractaliteStaffProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int i = 0; i < 5; i++)
            {
                int dustIndex = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Harpy);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            int proj = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, direction * speed, ProjectileID.HarpyFeather, Projectile.damage, Projectile.knockBack, Projectile.owner);
